    ...
    )
{
  ...
  while (1)
  {
    ...
    for (i = 1; i < N; i++)
      ...
      Res[i] = Res[i] - a[i] * dx * u[i] - 0.25 * a[i + 1] * u[i] * u[i] - 0.25 * a[i] * u[i] * u[i]
          + 0.25 * a[i] * u[i - 1] * u[i] + 0.25 * a[i - 1] * u[i - 1] * u[i];
      Res[i] = Res[i] + 0.25 * a[i - 1] * u[i - 1] * u[i - 1] + 0.25 * a[i] * u[i - 1] * u[i - 1];
      Res[i] = Res[i] + 0.25 * a[i - 1] * p[i - 1] + 0.25 * a[i] * p[i - 1] + 0.25 * a[i - 1] * p[i]
          - 0.25 * a[i + 1] * p[i] - 0.25 * a[i] * p[i + 1] - 0.25 * a[i + 1] * p[i + 1];

      /* Continuity */
      Res[i + N + 1] = -(a[i] - a_n[i]) * dx + p_old[i] * gamma * dx;
      Res[i + N + 1] = Res[i + N + 1] + 0.25 * a[i - 1] * u[i - 1] + 0.25 * a[i] * u[i - 1] + 0.25 * a[i - 1] * u[i]
          - 0.25 * a[i + 1] * u[i] - 0.25 * a[i] * u[i + 1] - 0.25 * a[i + 1] * u[i + 1];
    ...
    for (i = 1; i < N; i++)
        {
      // Momentum, Velocity
      LHS[i][i - 1] = LHS[i][i - 1] - 0.25 * a[i - 1] * u[i - 1] * 2 - 0.25 * a[i] * u[i - 1] * 2 - 0.25 * a[i] * u[i]
          + 0.25 * a[i - 1] * u[i];
      LHS[i][i] = LHS[i][i] + 0.25 * a[i + 1] * u[i + 1] + 0.25 * a[i] * u[i + 1] + a[i] * dx
          + 0.25 * a[i + 1] * u[i] * 2 + 0.25 * a[i] * u[i] * 2 - 0.25 * a[i] * u[i - 1] - 0.25 * a[i - 1] * u[i - 1];
