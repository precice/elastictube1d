...
{
  cout << "Starting Solid Solver..." << endl;
  ...
  if (argc != 3) {
    ...
    cout << endl;
    cout << "N:     Number of mesh elements, needs to be equal for fluid and Solid solver." << endl;
    return -1;
  }
